...
document.getElementById('toggle-btn').addEventListener('click', function() {
    ...
    if (quixnav.classList.contains('collapsed')) {
      quixnav.classList.remove('collapsed');
      quixnav.classList.add('expanded');
      var quixnav = document.querySelector('.quixnav');
    } else {
      quixnav.classList.remove('expanded');
      quixnav.classList.add('collapsed');
    }
  });