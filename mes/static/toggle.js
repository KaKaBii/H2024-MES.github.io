...
function updateArrows() {
    ...
    if (currentSortColumn !== null) {
        const columnArrow = document.getElementById(['serialArrow', 'planArrow', 'productArrow', 'numberArrow', 'materialArrow','dateArrow','timeArrow','orderArrow'][currentSortColumn]);
